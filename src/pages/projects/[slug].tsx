        ...
        >
          <ProjectDescription>
            <img
              ...
              alt={PrismicDOM.RichText.asText(project.data.title)}
            />
            <div
            ...
            <div className="links">
              {project.data.link_project != "" && (
                <a
                  href={PrismicDOM.RichText.asText(project.data.link_project)}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {router.locale == "pt-br" ? "Veja ao vivo" : "See it live"}
                </a>
              )}
              {project.data.link_github != "" && (
                <a
                  href={PrismicDOM.RichText.asText(project.data.link_github)}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {router.locale == "pt-br" ? "Veja o código" : "See the code"}
                </a>
              )}
            </div>
            <div className="links">
              <Link href="/">
                <a>{router.locale == "pt-br" ? "Voltar" : "Back"}</a>
              </Link>
            </div>
          </ProjectDescription>
        </motion.div>
